export const responseMessage = (name: string) => `<!doctype html>
               ...
               <table cellpadding="0" cellspacing="0" width="100%">
                 <tr>
                  <td width="560" align="center" valign="top">
                   <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                      <td align="center" class="es-p10t es-p10b" style="font-size: 0px"><amp-img src="${process.env.PORT}/images/logo.png" alt="" style="display:block" width="220" class="adapt-img" height="135" layout="responsive"></amp-img></td>
                     </tr>
                     <tr>
                      <td align="center" class="es-p10b es-m-txt-c es-text-2448"><h1 style="font-size: 46px;line-height: 46px"><span class="es-text-mobile-size-36" style="font-size:36px;line-height:36px">Reply to Message</span><span style="font-size:36px;line-height:36px">​</span><span class="es-text-mobile-size-36">​</span></h1></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
         ...
         <tr>
          <td align="center">
           <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600">
               ...
               <table cellpadding="0" cellspacing="0" width="100%">
                 <tr>
                  <td width="560" align="center" valign="top">
                   <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                      <td align="left"><p>Dear ${name},</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
             ...
             <tr>
              <td class="es-p20r es-p20l es-p10t" align="left">
               <table cellpadding="0" cellspacing="0">
                 <tr>
                  <td width="560" align="left">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                     <tr>
                      <td align="left"><p>Thanks for reaching out. This website is part of my demo projects series for my portfolio website.</p><p>​</p><p>If you like to work with me please contact or send me a message at <a target="_blank" href="mailto:sheharyarali689@gmail.com">Sheharyarali689@gmail.com</a>.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                 <tr>
                  <td width="270" align="left">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                     <tr>
                      <td align="left"><p>Regards,</p><p>Sheharyar</p><p>Web developer</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table> 
