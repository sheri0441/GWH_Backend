                                      ...
                                      >
                                        <div>
                                          <div
                                            ...
                                            "
                                          >
                                            Order date: ${orderDetail.orderedOn.getDate()}/${orderDetail.orderedOn.getMonth() + 1}/${orderDetail.orderedOn.getFullYear()}
                                          </div>
                                        </div>
                                      </td>
                                    </tr>
                                ...
                                >
                                  <div>
                                    ...
                                    >
                                      ...
                                      ${orderDetail.area},${orderDetail.zip}<br />
                                      ${orderDetail.city}
                                    </div>
                                  </div>
                                </td>
                              ...
                              <tr>
                                ...
                                >
                                  <div>
                                    ...
                                    >
                                      <a
                                        href="mailto:${process.env.PERSONAL_EMAIL}?subject=reply to confirmation"
                                        target="_blank"
                                        style="
                                          color: #3075a6;
                                          text-decoration: none;
